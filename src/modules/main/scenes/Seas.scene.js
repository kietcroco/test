...
class Seas extends React.PureComponent {
	...
	componentWillReceiveProps(nextProps) {
		...
		if( nextProps.reducers.message ) {
			...
			alertUtil({
				title: nextProps.reducers.messageTitle || translate("#$seas$#Cảnh báo"),
	...
	_renderRow(rowData, sectionID, rowID, highlightRow) {
		...
		return (
			<RowItem onPress={ () => {
				//console.log(`/seas${getDetailRouteName( rowData.exchanges )}`);
