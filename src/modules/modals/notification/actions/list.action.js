...
import { itemPerPageNotification as itemPerPage } from '~/configs/application';
import { translate } from '~/utilities/language';
import service from '~/services/notification/tracker';
import _ from 'lodash';

// key reducer
const key = `${namespace}/list`;
...
export default {
	...
	// load dữ liệu
	fetchData(options: Object = {}, type = "nextPage") {
