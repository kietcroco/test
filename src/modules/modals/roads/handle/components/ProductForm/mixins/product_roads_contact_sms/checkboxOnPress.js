...
export default function onPress() {
	...
	if( !this.state.product_roads_contact_sms.checked ) {
		...
		// nếu đã chọn phone
		if( this.state.product_roads_contact_phone.checked && this.state.product_roads_contact_phone.editable ) {
		...
		this.setState({
			...
			if( !editable ) {
				...
				this.refs.product_roads_contact_phone.focus();
				return;
			} 
	...
	if( !this.state.product_roads_contact_phone.checked && !this.state.product_roads_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.product_roads_contact_phone.checked && !this.state.product_roads_contact_phone.value ) {
