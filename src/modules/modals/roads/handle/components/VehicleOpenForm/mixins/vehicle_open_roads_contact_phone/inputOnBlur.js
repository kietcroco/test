...
export default function onBlur() {
	...
	let editable = this.state.vehicle_open_roads_contact_phone.editable;
	...
	if( 
		...
		this.setState({
			...
			contact_message
		}/*, () => (messageType || contact_message) && this.refs.vehicle_open_roads_contact_email.focus()*/);
	...
	if( this.state.vehicle_open_roads_contact_phone.checked ) {
		...
		this.setState({
			...
			if( !editable ) {
				...
				return this.refs.vehicle_open_roads_contact_sms.focus();
			}
