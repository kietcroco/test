...
export default function onPress() {
	...
	if( !this.state.vehicle_open_roads_contact_sms.checked && !this.state.vehicle_open_roads_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.vehicle_open_roads_contact_sms.checked && !this.state.vehicle_open_roads_contact_sms.value ) {
