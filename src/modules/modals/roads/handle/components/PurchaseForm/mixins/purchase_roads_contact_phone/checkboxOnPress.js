...
export default function onPress() {
	...
	if( !this.state.purchase_roads_contact_sms.checked && !this.state.purchase_roads_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.purchase_roads_contact_sms.checked && !this.state.purchase_roads_contact_sms.value ) {
