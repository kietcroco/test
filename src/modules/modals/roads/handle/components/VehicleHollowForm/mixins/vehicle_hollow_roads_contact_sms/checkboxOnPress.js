...
export default function onPress() {
	...
	if( !this.state.vehicle_hollow_roads_contact_sms.checked ) {
		...
		// nếu đã chọn phone
		if( this.state.vehicle_hollow_roads_contact_phone.checked && this.state.vehicle_hollow_roads_contact_phone.editable ) {
		...
		this.setState({
			...
			if( !editable ) {
				...
				this.refs.vehicle_hollow_roads_contact_phone.focus();
				return;
			} 
	...
	if( !this.state.vehicle_hollow_roads_contact_phone.checked && !this.state.vehicle_hollow_roads_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.vehicle_hollow_roads_contact_phone.checked && !this.state.vehicle_hollow_roads_contact_phone.value ) {
