...
export default function onBlur() {
	...
	let checked = isEmail( this.state.vehicle_hollow_roads_contact_email.value );
	let messageType = null;
	let message = "";
	let contact_message = "";

	if( !checked && !this.state.vehicle_hollow_roads_contact_phone.checked && !this.state.vehicle_hollow_roads_contact_sms.checked ){
	...
	} else if( this.state.vehicle_hollow_roads_contact_email.value && !checked ) {
