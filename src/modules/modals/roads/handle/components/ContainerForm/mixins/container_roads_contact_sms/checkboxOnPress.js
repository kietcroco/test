...
export default function onPress() {
	...
	if( !this.state.container_roads_contact_sms.checked ) {
		...
		// nếu đã chọn phone
		if( this.state.container_roads_contact_phone.checked && this.state.container_roads_contact_phone.editable ) {
	...
	if( !this.state.container_roads_contact_phone.checked && !this.state.container_roads_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.container_roads_contact_phone.checked && !this.state.container_roads_contact_phone.value ) {
