...
class Purchase extends React.Component {
				...
				if (res.data.STATUS === "OK" || res.data.STATUS === "NONAUTHORITATIVE" && res.data.data) {
					...
					if (res.data.data.account) {
						...
						if (res.data.data.account.status) {
							...
							// qua trang chi tiết
							return this.props.navigation.replace("/rivers/detail/purchase", {
								source: res.data.data,
								id: res.data.data.id || res.data.data.purchase_rivers_id
							});
						}
	...
	render() {
		...
		return (
			...
			>
				<Banner exchange="rivers">{translate("Mua bán - S&P")}</Banner>
