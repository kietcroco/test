...
export default function onBlur() {
	...
	let checked = isEmail( this.state.product_rivers_contact_email.value );
	let messageType = null;
	let message = "";
	let contact_message = "";

	if( !checked && !this.state.product_rivers_contact_phone.checked && !this.state.product_rivers_contact_sms.checked ){
	...
	} else if( this.state.product_rivers_contact_email.value && !checked ) {
