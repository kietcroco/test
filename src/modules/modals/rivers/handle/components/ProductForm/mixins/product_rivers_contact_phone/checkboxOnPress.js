...
export default function onPress() {
	...
	if( !this.state.product_rivers_contact_sms.checked && !this.state.product_rivers_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.product_rivers_contact_sms.checked && !this.state.product_rivers_contact_sms.value ) {
