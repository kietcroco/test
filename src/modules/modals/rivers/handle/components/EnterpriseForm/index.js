...
import {
	...
	enterprise_rivers_career as mixinsCareer,
	enterprise_rivers_vehicle_counter as mixinsVehicleCounter,
	...
	render() {
		...
		return (
			<View>
				...
				<TextInput
					ref           = "enterprise_rivers_career"
					label         = {translate("Ngành nghề chính")}
					placeholder   = {translate("Chọn")}
					type          = "select"
					style         = {_styles.input}
					returnKeyType = "next"
					//messageType   = {this.state.enterprise_rivers_career.messageType}
					value         = {this.state.enterprise_rivers_career.label}
					onPress       = {mixinsCareer.inputOnPress.bind(this)}
					required
				>{/*this.state.enterprise_rivers_career.message*/}</TextInput>
				<ModalCollapse
					visible        = {this.state.enterprise_rivers_career.modalVisible}
					value          = {this.state.enterprise_rivers_career.value}
					defaultValue   = {[]}
					source         = {careerJSON}
				...
				<TextInput
					ref           = "enterprise_rivers_vehicle_counter"
					...
					//messageType   = {this.state.enterprise_rivers_vehicle_counter.messageType}
					value         = {this.state.enterprise_rivers_vehicle_counter.value}
					onChangeText  = {mixinsVehicleCounter.inputOnChangeText.bind(this)}
				>{/*this.state.enterprise_rivers_vehicle_counter.message*/}</TextInput>
