...
export default function onPress() {
	...
	if( !this.state.purchase_rivers_contact_sms.checked && !this.state.purchase_rivers_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.purchase_rivers_contact_sms.checked && !this.state.purchase_rivers_contact_sms.value ) {
