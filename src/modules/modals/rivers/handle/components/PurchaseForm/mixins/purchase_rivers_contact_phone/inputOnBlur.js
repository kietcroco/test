...
export default function onBlur() {
	...
	let editable = this.state.purchase_rivers_contact_phone.editable;
	...
	if( 
		...
		this.setState({
			...
			contact_message
		}/*, () => (messageType || contact_message) && this.refs.purchase_rivers_contact_email.focus()*/);
	...
	if( this.state.purchase_rivers_contact_phone.checked ) {
		...
		this.setState({
			...
			if( !editable ) {
				...
				return this.refs.purchase_rivers_contact_sms.focus();
			}
