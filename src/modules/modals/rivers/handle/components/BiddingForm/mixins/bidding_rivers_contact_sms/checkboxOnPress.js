...
export default function onPress() {
	...
	if( !this.state.bidding_rivers_contact_sms.checked ) {
		...
		// nếu đã chọn phone
		if( this.state.bidding_rivers_contact_phone.checked && this.state.bidding_rivers_contact_phone.editable ) {
	...
	if( !this.state.bidding_rivers_contact_phone.checked && !this.state.bidding_rivers_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.bidding_rivers_contact_phone.checked && !this.state.bidding_rivers_contact_phone.value ) {
