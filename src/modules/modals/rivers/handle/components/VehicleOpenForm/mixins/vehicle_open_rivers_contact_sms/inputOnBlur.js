...
export default function onBlur() {
	...
	let editable = this.state.vehicle_open_rivers_contact_sms.editable;
	...
	if( 
		...
		this.setState({
			...
			contact_message
		}/*, () => (messageType || contact_message) && this.refs.vehicle_open_rivers_contact_email.focus()*/);
	...
	if( this.state.vehicle_open_rivers_contact_sms.checked ) {
		...
		this.setState({
			...
			if( !editable ) {
				...
				return this.refs.vehicle_open_rivers_contact_sms.focus();
			}
