...
export default function onBlur() {
	...
	let editable = this.state.purchase_seas_contact_sms.editable;
	...
	if( 
		...
		this.setState({
			...
			contact_message
		}/*, () => (messageType || contact_message) && this.refs.purchase_seas_contact_email.focus()*/);
	...
	if( this.state.purchase_seas_contact_sms.checked ) {
		...
		this.setState({
			...
			if( !editable ) {
				...
				return this.refs.purchase_seas_contact_sms.focus();
			}
