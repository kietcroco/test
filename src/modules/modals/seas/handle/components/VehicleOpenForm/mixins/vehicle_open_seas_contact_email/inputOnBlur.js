...
export default function onBlur() {
	...
	let checked = !!this.state.vehicle_open_seas_contact_email.value.length;
	let messageType = null;
	let message = "";
	let contact_message = "";

	if( !checked && !this.state.vehicle_open_seas_contact_phone.checked && !this.state.vehicle_open_seas_contact_sms.checked ){
	...
	} else if( this.state.vehicle_open_seas_contact_email.value && !checked ) {
