...
export default function onSubmitEditing() {
	...
	let editable = this.state.vehicle_open_seas_contact_phone.editable;
	...
	if( this.state.vehicle_open_seas_contact_phone.checked ) {
		...
		this.setState({
			...
			vehicle_open_seas_contact_email: {
				...this.state.vehicle_open_seas_contact_email,
				messageType: !isEmailDetect ? this.state.vehicle_open_seas_contact_email.messageType : null,
				message: !isEmailDetect ? this.state.vehicle_open_seas_contact_email.message : "",
			},
			contact_message
		}, () => this.refs.vehicle_open_seas_contact_email.focus());
