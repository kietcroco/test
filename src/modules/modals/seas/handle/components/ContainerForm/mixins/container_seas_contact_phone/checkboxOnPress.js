...
export default function onPress() {
	...
	if( !this.state.container_seas_contact_sms.checked && !this.state.container_seas_contact_email.checked ) {
	...
	this.setState({
		...
		if( this.state.container_seas_contact_sms.checked && !this.state.container_seas_contact_sms.value ) {
