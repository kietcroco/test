...
import { pinchDistance, angleDistance } from './TouchDistanceMath';
 ...
 * @returns {*}
 */
const convertToMillisecIfNeeded = (interval: Number) => {
 ...
 * @returns {boolean}
 */
const effectiveMove = (config: Object, gestureState: Object) => {
...
const initializeGestureState = (gestureState: Object = {}) => {
	...
	gestureState.angle = undefined;
	gestureState.previousAngle = undefined;
};

const updateGestureStateOnMove = (gestureState: Object, touchHistory: Object, e) => {
	...
	gestureState.angle = angleDistance(touchHistory, movedAfter, true);
	gestureState.previousAngle = angleDistance(touchHistory, movedAfter, false);
};

const clearInteractionHandle = interactionState => {
...
const cancelSingleTapConfirm = (gestureState: Object) => {
 ...
 * @returns {{}}
 */
export default function create(config: Object = {}) {
	if (config.debug) {
		DEV = true;
	}
